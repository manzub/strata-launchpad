...
const SvgUniswapUniLogo = (props) => (
  <svg
    id="uniswap-uni-logo_svg__Layer_1"
  ...
  >
    <style>
      {
        ".uniswap-uni-logo_svg__st0,.uniswap-uni-logo_svg__st1{fill:#ff007a}.uniswap-uni-logo_svg__st1{fill-rule:evenodd;clip-rule:evenodd}"
      }
    </style>
    <path
      className="uniswap-uni-logo_svg__st0"
    ...
    />
    <path
      className="uniswap-uni-logo_svg__st1"
...
export default SvgUniswapUniLogo;
