...
const SvgPancakeswapCakeLogo = (props) => (
  <svg
    id="pancakeswap-cake-logo_svg__Layer_1"
    ...
    {...props}
  >
    <style>{".pancakeswap-cake-logo_svg__st3{fill:#633001}"}</style>
    <path
    ...
    />
    <path
      className="pancakeswap-cake-logo_svg__st3"
...
export default SvgPancakeswapCakeLogo;
