  ...
  return(
    <>
      <header ref={refMobileHeader} className='mobile-header'>
        <div className='contianer-fluid flex-grow-1' style={{padding:'0px 10px'}}>
          <div className='row'>
            <div className='col'>
							{hasLeftMobileMenu && (
								<Button
            ...
            {hasRightMobileMenu && (
							<div className='offset col-auto'>
								...
								/> */}
                <ConnectWalletButton />
                <Button color={rightMenuStatus ? 'primary' : themeStatus} size='lg' icon={'AccountCircle'} aria-label='Account' />
							</div>
						)}
          </div>
        </div>
      ...
      <header ref={refHeader} className={classNames('header', {
					'header-left-open': leftMenuStatus,
					'header-right-open': rightMenuStatus,
				})}>
          <div className='contianer-fluid flex-grow-1'>
